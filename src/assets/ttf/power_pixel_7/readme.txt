...
True Type Font: Power Pixel-7 version 1.0


EULA
-==-
The font Power Pixel-7 is freeware for home using only.


DESCRIPTION
-=========-
Original square font. Size is 7*7 pixels. Latin and Cyrillic code pages are supported.

Files in power_pixel-7.zip:
       	readme.txt     			this file;
        power_pixel-7.ttf    		regular font;
	power_pixel-7.fon   		font in windows "FON" format;
	power_pixel-7_screen.png		preview image.
