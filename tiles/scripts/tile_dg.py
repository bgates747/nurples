...
def generate_asm_levels(combined_xml_filepath, asm_levels_filepath):
    """
    Generate assembly code for levels definition based on map CSV files.
